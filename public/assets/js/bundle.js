...
/* harmony export */   "default": () => (/* binding */ creatPassword)
/* harmony export */ });
var rand = function rand(min, max) {
  return Math.floor(Math.random() * (max - min) + min);
};

var Creatmaisculas = function Creatmaisculas() {
  return String.fromCharCode(rand(64, 91));
};

var creatMinus = function creatMinus() {
  return String.fromCharCode(rand(97, 123));
};

var creatNumber = function creatNumber() {
  return String.fromCharCode(rand(48, 58));
};

var Simbol = ')(*&¨%$#@!?:><.,}{][^~';
function creatPassword(qtd, maisculas, minus, simbol, numeros) {
  var creatSimbol = Simbol[rand(0, Simbol.length)];
...
/* harmony export */ });
/* harmony import */ var _creatPassword__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./creatPassword */ "./src/modules/creatPassword.js");

var senhaGerada = document.querySelector('.senha-gerada');
var qntCaracteres = document.querySelector('.qtd-caracteres');
...
function gera() {
  console.log('oi');
  var senha = (0,_creatPassword__WEBPACK_IMPORTED_MODULE_0__.default)(qntCaracteres.value, chkMaisculas.checked, chkMinusculas.checked, chkSimbolos.checked, chkNumeros.checked);
...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_innerPassword__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../modules/innerPassword */ "./src/modules/innerPassword.js");
...
(0,_modules_innerPassword__WEBPACK_IMPORTED_MODULE_0__.default)();
})();
